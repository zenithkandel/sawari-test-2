  ...
  <body>
    ...
    <header id="command-bar">
      ...
      <div class="cb-center">
        <div id="add-entity-group" class="cb-btn-group" style="display: none">
          ...
          <button
            class="cb-entity-btn"
            data-entity="obstruction"
            title="Add Obstruction (O)"
          >
    ...
    <footer id="status-strip">
      <div class="status-left">
        <span id="status-mode"
          ><i class="fa-solid fa-arrow-pointer"></i> Select Mode</span
        >
      ...
      <div class="search-dialog">
        <div class="search-input-wrap">
          ...
          <input
            type="text"
            id="search-input"
            placeholder="Search stops, routes, vehicles..."
            autocomplete="off"
          />
          <kbd>Esc</kbd>
        </div>
