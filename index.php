  ...
  <body>
    ...
    <div id="live-panel">
      ...
      <button
        ...
        id="btn-nearby-stops"
        title="Show nearby stops"
      >
        <i class="fa-solid fa-map-pin"></i> Nearby
      </button>
      <button
        class="btn btn-sm btn-success hidden"
        id="btn-use-gps-start"
        title="Use GPS as start location"
      >
    ...
    <template id="tpl-vehicle-micro">
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M11 26v-8c0-4 3-7 7-7h20c3 0 6 1 8 4l6 7h4c2 0 4 2 4 4v2c0 2-2 4-4 4h-3a6 6 0 0 1-12 0H27a6 6 0 0 1-12 0h-1c-2 0-3-1-3-3z" fill="__COLOR__" stroke="#0f172a" stroke-width="2" />
